...
if __name__ == "__main__":
    ...
    bbox_of_interest = get_bbox_wgs84(img4ext=None, 
                                      extent_target=(375500, 6819500, 427500, 6878500), 
                                      epsg_target=32719, 
                                      buffer_m=100)
    ...
    # Modify "href" for all assets and for each item and update stac_items to direct point to the /eodata
    new_stac_items = []
    ...
    # load one slice
    a=ds.B01[:10,:10,1].values


    
    # ds = rioxarray.open_rasterio("/eodata/Sentinel-2/MSI/L1C_N0500/2023/01/03/S2B_MSIL1C_20230103T143729_N0510_R096_T19JCJ_20240811T114613.SAFE/GRANULE/L1C_T19JCJ_A030438_20230103T144503/IMG_DATA/T19JCJ_20230103T143729_B02.jp2",
    #                         chunks={})
    ...
    # api_url = 'https://cmr.earthdata.nasa.gov/stac'
    ...
    # rasterio.env.Env(session=session)
    ...
    print([c.id for c in client.get_collections()])
    
    
    
 
    item = stac_items[0].to_dict()

    for asset in item["assets"]:
        item["assets"][asset]["href"] = item["assets"][asset]["href"][4:]
